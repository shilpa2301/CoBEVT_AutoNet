...
model = dict(
    ...
    bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            pc_range=[-51.2, -51.2], # [-54.0, -54.0],
            post_center_range=[-61.2, -61.2, -10.0, 61.2, 61.2, 10.0],  # [-54.0, -54.0, -5.0, 54.0, 54.0, 3.0],
            score_threshold=0.0,
            out_size_factor=8,
            voxel_size=[0.2, 0.2], # [0.1, 0.1],
            code_size=8),
        loss_cls=dict(
            ...
            loss_weight=0.1),
        loss_heatmap=dict(
            type='mmdet.GaussianFocalLoss', reduction='mean', loss_weight=0.1),
        loss_bbox=dict(

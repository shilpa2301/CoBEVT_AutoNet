...
class CorpBEVTLidar(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        lidar_features = []
        #shilpa lidar
        for agent, data in lidar_data[0].items():
        ...
        # Lidar encoder
        # batch_dict.update({'features': lidar_features})
        # lidar_features = self.lidar_encoder(batch_dict)
        self.lidar_encoder(batch_inputs_dict={'points': [lidar_features]},
                                                       batch_data_samples=[])
